...
- [x] menjelaskan jenis-jenis biaya dan struktur biaya produksi.
- [x] menjelaskan keterkaitan biaya dan kinerja produksi.
- [x] menjelaskan maksimisasi keuntungan dari konsep biaya
- [x] menjelaskan penurunan fungsi penawaran dari biaya marjinal.
...
$$average\ total\ cost = \frac {total\ costs}{output}$$
$$average\ fixed\ cost = \frac {total\ fixed\ cost}{output} $$
...
$$marginal\ cost = \frac {\Delta\ total\ cost}{\Delta\ output} $$
